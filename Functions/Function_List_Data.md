...
| `read_com_port(1)`              | No   | Reads an unspecified[^2] number of waiting characters. No delay before or after read.                                 |
| `read_com_port(1,20)`           | No   | Reads up to[^2] specified number (20) of waiting characters. No delay before or after read.                           |
